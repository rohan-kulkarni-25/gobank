...
/*
RUN: Starting Server and Handling Routes.
/login /account / account/{id} /transer
*/
...
// API HANDLERS - METHODS FOR API SERVER - RETURNING RESPONSE & REQUEST
...
/*
Make HTTP HANDLE FUN ( Acts as wrapper )
